...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    if (count == 12)
    {
      if ((strncmp(input, "270027D030E0", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "270027D030E0", 12) == 0) && (a == 0))
      {
        if(p1>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "270027CB77BC", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "270027CB77BC", 12) == 0) && (a == 0))
      {
         if(p2>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "270027CCE529", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "270027CCE529", 12) == 0) && (a==0))
      {
        if(p3>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "4500412F654E", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "4500412F654E", 12) == 0) && (a == 0))
      {
        if(p4>0)
        {
        lcd.clear();
      ...
      else if (strncmp(input, "7C0089F8E7EA", 12) == 0)
      {
        lcd.clear();
        lcd.setCursor(0, 0);
